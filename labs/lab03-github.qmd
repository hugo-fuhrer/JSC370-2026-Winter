...
display(met[['temp']].describe().round(4))
...
```{python}
display(plt.hist(min_elev_station['temp'].dropna(), bins=50))
...
display(plt.plot(min_elev_station['date'], min_elev_station['temp'], linewidth=0.5, alpha=0.7))
plt.xlabel('Date')
